...
var fightOrSkip = function() {
    ...
    // conditional recursive function call goes here
        ...
        if (playerInfo.health > 0) {
            ...
            fight(pickedEnemyObj);
                ...
                if (playerInfo.health > 0 && i < enemyInfo.length - 1) {
                    ...
                    var storeConfirm = window.confirm("The fight is over. Would you care to visit the store before the next round?");
...
var endGame = function () {
    ...
    if (playerInfo.health > 0) {
        window.alert("Congratulations, you've survived the game! You now have a score of " + playerInfo.money + ". Let's see how you did compared to other robots!");
...
var shop = function() {
    ...
    // use parseInt() to convert strings to integers for number input
